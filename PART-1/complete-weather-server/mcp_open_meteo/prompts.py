...
def register_prompts(mcp: FastMCP):
    ...
    def weather_analysis(location: str, context: str = "") -> str:
        ...
        1. Current weather conditions (temparature, humidity, wind, pressure)
    ...
    def travel_weather_advisory(departure_location: str, destination_location: str, travel_date: str = "") -> List[base.Message]:
        """
        ...
        messages.extend([
            base.UserMessage("Can you provide a weather comprison and travel advisory?"),
            ...
            base.AssistantMessage("* Current weather conditions at both locations."),
            base.AssistantMessage("* Weather forecast for your travel period at both locations."),
            base.AssistantMessage("* Any weather alerts or severe conditions that might affect your travel."),
            base.AssistantMessage("* Recommendations for travel based on the weather conditions."),
            base.AssistantMessage("* Best times to travel if relevant.")
        ])
    ...
    def outdoor_activity_planner(location: str, activity: str, timeframe:str = "next 7 days") -> List[base.Message]:
        """
